...
import com.joko.movie2021.repository.collections.CollectionNames.NOW_PLAYING
import com.joko.movie2021.repository.collections.CollectionNames.POPULAR_NAME
import com.joko.movie2021.repository.collections.CollectionNames.TOP_RATED
...
sealed class CollectionType(val name: String) {
    ...
    object TopRated : CollectionType(TOP_RATED)
    object NowPlaying : CollectionType(NOW_PLAYING)
