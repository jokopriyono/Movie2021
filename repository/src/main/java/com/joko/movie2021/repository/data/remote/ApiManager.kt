package com.joko.movie2021.repository.data.remote

import com.haroldadmin.cnradapter.NetworkResponse
import com.joko.movie2021.core.Resource
import com.joko.movie2021.repository.data.remote.service.account.AccountDetailsResponse
...
import com.joko.movie2021.repository.data.remote.service.auth.CreateSessionRequest
            ...
            .flatMap { response ->
                Single.just(
                    when (response) {
                        ...
                        is NetworkResponse.ServerError -> {
                            Resource.Error<AccountDetailsResponse>(
